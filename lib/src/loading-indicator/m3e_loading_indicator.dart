...
class M3ELoadingIndicator extends ProgressIndicator {
  ...
  /// Defines minimum and maximum sizes for an [M3ELoadingIndicator].
  ...
  }) : assert(shapes != null ? shapes.length > 1 : true);
...
class _M3ELoadingIndicatorState extends State<M3ELoadingIndicator>
  ...
  void initState() {
    ...
    final shapesList = widget.shapes ?? _defaultShapes;
    _polygons = shapesList.map((s) => s.polygon).toList();
